...
output = args.output
#网格
points = np.array([[0.0, 0.0],[0.15,0.0],[0.15,0.05],[0.0,0.05]],dtype = np.float64)
facets = np.array([[0,1],[1,2],[2,3],[3,0]],dtype = np.int_)

p, f = MF.circle_interval_mesh([0.075,0.025],0.01,0.001)
...
smesh = MF.meshpy2d(points, facets,h,hole_points=[[0.075,0.025]],facet_markers = fm,
        meshtype = 'tri')
