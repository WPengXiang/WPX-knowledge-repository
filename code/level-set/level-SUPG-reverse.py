...
def SUPG(u,s0,space): 
    ...
    E0 = np.einsum('i,ijk,ij,ijm,j ->jkm',\
            ws,gphi[...,0],u(bcs)[...,0],phi,cellmeasure)
    E1 = np.einsum('i,ijk,ij,ijm,j ->jkm',\
            ws,gphi[...,1],u(bcs)[...,1],phi,cellmeasure)
    E = E0+E1
